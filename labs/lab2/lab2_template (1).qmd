...
ggplot() +
  geom_sf(data = pa_counties, fill = "black", color = "black") +
  geom_sf(data = underserved %>% filter(serv_under_or == "underserved"), 
          aes(fill = dist_near_hos), color = "black") +
  scale_fill_gradient(low = "yellow", high = "red", name = "Distance (miles) from nearest hospital") +
  theme_void()
